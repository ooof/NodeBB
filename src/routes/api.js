...
module.exports =  function(app, middleware, controllers) {
	...
	router.post('/uploadimage', multipartMiddleware, middleware.applyCSRF, uploadsController.uploadPostImage);
	router.post('/uploadfile', multipartMiddleware, middleware.applyCSRF, uploadsController.uploadPostFile);
